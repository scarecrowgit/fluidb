...
///
/// Version 5 adds `pending_reclaim` for deferred dropped-partition artifact reclamation.
...
/// identifier high-water mark (`id_high_water`). Versions 1 through 4 remain decodable.
...
pub fn decode_snapshot(bytes: &[u8]) -> Result<CatalogSnapshot> {
    ...
    if version >= 5 && probe.get("pending_reclaim").is_none() {
        return Err(HtapError::Corruption(
            "catalog format version 5 payload is missing pending_reclaim".into(),
        ));
    }
...
mod tests {
    use super::*;
    use crate::model::*;
    use htap_common::{ColumnDef, DataType, Schema, Value};
    ...
    // Frozen copy, do not refactor: reference encoder for the v4 payload shape.
    fn encode_v4(snapshot: &CatalogSnapshot) -> Vec<u8> {
        let mut payload = serde_json::to_value(snapshot).unwrap();
        payload.as_object_mut().unwrap().remove("pending_reclaim");
        encode_reference_payload(4, &payload)
    }
    ...
    fn catalog_envelope_golden_bytes() {
        ...
        // Decode-only fixtures copied from catalog files written by older versions.
        let v1 = vec![
            72, 84, 65, 80, 67, 65, 84, 49, 1, 0, 210, 1, 0, 0, 141, 99, 75, 186, 123, 34, 103,
            101, 110, 101, 114, 97, 116, 105, 111, 110, 34, 58, 49, 44, 34, 112, 97, 114, 116, 105,
            116, 105, 111, 110, 115, 34, 58, 91, 123, 34, 103, 101, 110, 101, 114, 97, 116, 105,
            111, 110, 34, 58, 49, 44, 34, 105, 100, 34, 58, 49, 44, 34, 110, 97, 109, 101, 34, 58,
            34, 112, 48, 34, 44, 34, 115, 116, 111, 114, 97, 103, 101, 34, 58, 34, 82, 111, 119,
            34, 44, 34, 116, 97, 98, 108, 101, 95, 105, 100, 34, 58, 49, 44, 34, 116, 97, 98, 108,
            101, 116, 115, 34, 58, 91, 49, 93, 125, 93, 44, 34, 114, 101, 112, 108, 105, 99, 97,
            115, 34, 58, 91, 123, 34, 103, 101, 110, 101, 114, 97, 116, 105, 111, 110, 34, 58, 49,
            44, 34, 104, 101, 97, 108, 116, 104, 121, 34, 58, 116, 114, 117, 101, 44, 34, 105, 100,
            34, 58, 49, 44, 34, 105, 115, 95, 108, 101, 97, 100, 101, 114, 34, 58, 116, 114, 117,
            101, 44, 34, 110, 111, 100, 101, 95, 105, 100, 34, 58, 49, 44, 34, 116, 97, 98, 108,
            101, 116, 95, 105, 100, 34, 58, 49, 125, 93, 44, 34, 116, 97, 98, 108, 101, 115, 34,
            58, 91, 123, 34, 103, 101, 110, 101, 114, 97, 116, 105, 111, 110, 34, 58, 49, 44, 34,
            105, 100, 34, 58, 49, 44, 34, 110, 97, 109, 101, 34, 58, 34, 116, 101, 115, 116, 95,
            116, 97, 98, 108, 101, 34, 44, 34, 112, 97, 114, 116, 105, 116, 105, 111, 110, 115, 34,
            58, 91, 49, 93, 44, 34, 112, 114, 105, 109, 97, 114, 121, 95, 107, 101, 121, 34, 58,
            91, 48, 93, 44, 34, 115, 99, 104, 101, 109, 97, 34, 58, 123, 34, 99, 111, 108, 117,
            109, 110, 115, 34, 58, 91, 123, 34, 100, 97, 116, 97, 95, 116, 121, 112, 101, 34, 58,
            34, 73, 110, 116, 54, 52, 34, 44, 34, 110, 97, 109, 101, 34, 58, 34, 107, 34, 44, 34,
            110, 117, 108, 108, 97, 98, 108, 101, 34, 58, 102, 97, 108, 115, 101, 44, 34, 112, 114,
            105, 109, 97, 114, 121, 95, 107, 101, 121, 34, 58, 116, 114, 117, 101, 125, 93, 125,
            125, 93, 44, 34, 116, 97, 98, 108, 101, 116, 115, 34, 58, 91, 123, 34, 98, 117, 99,
            107, 101, 116, 34, 58, 48, 44, 34, 103, 101, 110, 101, 114, 97, 116, 105, 111, 110, 
            97, 99, 99, 111, 117, 110, 116, 34, 58, 48, 44, 34, 116, 97, 98, 108, 101, 34, 58, 48,
            44, 34, 112, 97, 114, 116, 105, 116, 105, 111, 110, 34, 58, 48, 44, 34, 116, 97, 98,
            108, 101, 116, 34, 58, 48, 44, 34, 114, 101, 112, 108, 105, 99, 97, 34, 58, 48, 125,
            125,
        ];

        let decoded_v4 = decode_snapshot(&v4).expect("v4 golden fixture must decode");
        assert_eq!(decoded_v4, snapshot);
        assert!(decoded_v4.pending_reclaim.is_empty());

        let mut v5_snapshot = snapshot;
        v5_snapshot.pending_reclaim = vec![PendingReclaim {
            table_id: TableId::new(99),
            table_name: "dropped".into(),
        ...
        let actual_v5 = encode_snapshot(&v5_snapshot).unwrap();
        assert_eq!(&actual_v5[..HEADER_MAGIC.len()], HEADER_MAGIC);
        assert_eq!(u16::from_le_bytes(actual_v5[8..10].try_into().unwrap()), 5);

        let payload_len = u32::from_le_bytes(actual_v5[10..14].try_into().unwrap()) as usize;
        let expected_crc = u32::from_le_bytes(actual_v5[14..18].try_into().unwrap());
        let payload = &actual_v5[HEADER_LEN..];
        assert_eq!(payload_len, payload.len());
        assert_eq!(expected_crc, crc32c::crc32c(payload));

        let payload_json: serde_json::Value = serde_json::from_slice(payload).unwrap();
        assert!(payload_json.get("pending_reclaim").is_some());
        assert_eq!(decode_snapshot(&actual_v5).unwrap(), v5_snapshot);
    }

    #[test]
    fn catalog_v5_pending_reclaim_roundtrip_and_required_field() {
        let mut snapshot = test_snapshot();
        snapshot.tables[0].stats = Some(TableStats {
            analyzed_at_version: 10,
            row_count: 1,
        ...
        snapshot.pending_reclaim = vec![
            PendingReclaim {
                table_id: TableId::new(99),
                table_name: "dropped_a".into(),
                catalog_generation: 2,
                dropped: vec![DroppedPartitionArtifact {
                    partition_id: PartitionId::new(99),
                    tablet_id: TabletId::new(99),
                }],
                created_at_unix_ms: 1,
                colstore_and_movement_reclaimed: false,
                rowstore_purge_confirmed: true,
        ...
        let mut payload = serde_json::to_value(&snapshot).unwrap();
        payload.as_object_mut().unwrap().remove("pending_reclaim");
        let err = decode_snapshot(&encode_reference_payload(5, &payload))
            .expect_err("v5 payload without pending_reclaim must fail");
        assert_eq!(
            err.to_string(),
            "Corruption error: catalog format version 5 payload is missing pending_reclaim"
        );
    }
    ...
    fn catalog_envelope_bad_version_and_crc() {
        ...
        let v4 = encode_v4(&test_snapshot());

        let mut v6_version = v4.clone();
        v6_version[8..10].copy_from_slice(&6u16.to_le_bytes());
        let err = decode_snapshot(&v6_version).expect_err("v6 envelope must fail");
        assert_eq!(
            err.to_string(),
            "Corruption error: unsupported catalog format version: 6"
        );

        let mut corrupted_v4_payload = v4;
        corrupted_v4_payload[HEADER_LEN] ^= 0xff;
        let err = decode_snapshot(&corrupted_v4_payload)
            .expect_err("v4 envelope with corrupted payload must fail");
        assert!(matches!(err, HtapError::Corruption(_)));

        let mut bad_crc = encode_snapshot(&test_snapshot()).unwrap();
        bad_crc[14] ^= 0xff;
        let expected = u32::from_le_bytes(bad_crc[14..18].try_into().unwrap());
        let actual = crc32c::crc32c(&bad_crc[HEADER_LEN..]);
        let err = decode_snapshot(&bad_crc).expect_err("bad CRC must fail");
        assert_eq!(
            err.to_string(),
            format!(
                "Corruption error: catalog checksum mismatch: expected {expected:#010x}, got {actual:#010x}"
            )
        );
    }
