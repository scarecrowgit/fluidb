...
use crate::ast::{
    ...
    InitializeKind, MysqlPartitionBy, ObjectName, OnCommit, OneOrManyWithParens, Query,
...
pub struct CreateTableBuilder {
    ...
    /// MySQL `PARTITION BY` specification.
...
impl CreateTableBuilder {
    ...
    /// Set the MySQL `PARTITION BY` specification.
    pub fn mysql_partition_by(mut self, mysql_partition_by: Option<MysqlPartitionBy>) -> Self {
        self.mysql_partition_by = mysql_partition_by;
        self
    }
    ...
    pub fn build(self) -> CreateTable {
        CreateTable {
            ...
            backup: self.backup,
            mysql_partition_by: self.mysql_partition_by,
        }
    }
}
